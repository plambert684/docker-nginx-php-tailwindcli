...
function isFile(path) {
  return exists(path) && (0, _fsExtra.statSync)(path).isFile();
}
 ...
 */
function isDir(path) {
  return exists(path) && (0, _fsExtra.statSync)(path).isDirectory();
}
...
function readDirDeep(path) {
  return _glob2.default.sync(_path2.default.resolve(path, '**/*'), { nodir: true });
}
